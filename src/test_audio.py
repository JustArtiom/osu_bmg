...
import numpy as np
spec = audio_to_mel_spectrogram("dataset/audio.mp3", sr=22050, n_fft=2048, hop_ms=10, n_mels=128)
print(np.shape(spec.S_db))
spec.show(figsize=(20, 8))
# spec.save("spectrogram.png", figsize=(20, 8))
